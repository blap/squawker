...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(name) => "Sei sicuro/a di voler eliminare il gruppo di iscrizioni ${name}?";
  ...
  static String m11(errorMessage) => "Controlla la tua connessione a Internet.\n\n${errorMessage}";
  ...
  static String m15(filePath) => "Il file non esiste. Assicurati che si trovi in ${filePath}";

  static String m16(thisTweetUserName, timeAgo) => "${thisTweetUserName} ha ritwittato ${timeAgo}";
  ...
  static String m18(widgetPlaceName) => "Impossibile caricare le tendenze per ${widgetPlaceName}";
  ...
  static String m20(releaseVersion) => "Aggiorna a ${releaseVersion} tramite il tuo client F-Droid";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "confirm_close_fritter": MessageLookupByLibrary.simpleMessage("Sei sicuro di voler chiudere Squawker?"),
    ...
    "could_not_contact_twitter": MessageLookupByLibrary.simpleMessage("Impossibile contattare Twitter/X"),
    ...
    "enter_your_twitter_username": MessageLookupByLibrary.simpleMessage("Inserisci il tuo nome utente di Twitter/X"),
    ...
    "forbidden": MessageLookupByLibrary.simpleMessage("Twitter/X dice che l\'accesso non è consentito"),
    ...
    "help_make_fritter_even_better": MessageLookupByLibrary.simpleMessage("Aiuta a rendere Squawker migliore"),
    "help_support_fritters_future": MessageLookupByLibrary.simpleMessage("Aiuta a supportare il futuro di Squawker"),
    ...
    "import_from_twitter": MessageLookupByLibrary.simpleMessage("Importa da Twitter/X"),
    ...
    "something_broke_in_fritter": MessageLookupByLibrary.simpleMessage("Qualcosa si è rotto in Squawker."),
    ...
    "thanks_for_helping_fritter": MessageLookupByLibrary.simpleMessage("Grazie per aver aiutato Squawker! 💖"),
    "the_file_does_not_exist_please_ensure_it_is_located_at_file_path": m15,
    "the_github_issue": MessageLookupByLibrary.simpleMessage("issue GitHub (#143)"),
