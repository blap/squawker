...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(name) => "Ziur ${name} harpidetza taldea ezabatu nahi duzula?";
  ...
  static String m5(snapshotData) => "${snapshotData} erabiltzaileekin amaitu da";

  static String m6(name) => "Taldea: ${name}";

  static String m7(snapshotData) => "Orain arte inportatutako ${snapshotData} erabiltzaileak";
  ...
  static String m11(errorMessage) => "Mesedez, egiaztatu Internet konexioa.\n\n${errorMessage}";
  ...
  static String m15(filePath) => "Fitxategia ez da existitzen. Mesedez, ziurtatu ${filePath} helbidean dagoela";

  static String m16(thisTweetUserName, timeAgo) => "Orain dela ${timeAgo} ${thisTweetUserName} birtxiotua";
  ...
  static String m18(widgetPlaceName) => "Ezin dira joerak kargatu ${widgetPlaceName}";

  static String m19(responseStatusCode) =>
      "Ezin da multimedia gorde. Twitter/X-ek ${responseStatusCode} egoerara itzuli du";

  static String m20(releaseVersion) => "Eguneratu ${releaseVersion} zure F-Droid bezeroaren bidez";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "confirm_close_fritter": MessageLookupByLibrary.simpleMessage("Ziur al zaude Squawker itxi nahi duzula?"),
    ...
    "could_not_contact_twitter": MessageLookupByLibrary.simpleMessage("Ezin izan da Twitter/Xrekin harremanetan jarri"),
    ...
    "enter_your_twitter_username": MessageLookupByLibrary.simpleMessage("Sartu zure Twitter/X erabiltzaile-izena"),
    ...
    "forbidden": MessageLookupByLibrary.simpleMessage("Twitter/Xrek dio horretarako sarbidea debekatuta dagoela"),
    ...
    "help_make_fritter_even_better": MessageLookupByLibrary.simpleMessage("Lagundu Squawker hobetzen"),
    "help_support_fritters_future": MessageLookupByLibrary.simpleMessage("Lagundu Squawker-en etorkizuna bermatzen"),
    ...
    "import_from_twitter": MessageLookupByLibrary.simpleMessage("Inportatu Twitter/X-etik"),
    ...
    "something_broke_in_fritter": MessageLookupByLibrary.simpleMessage("Squawker-en zerbait hautsi da."),
    ...
    "thanks_for_helping_fritter": MessageLookupByLibrary.simpleMessage("Eskerrik asko Squawker laguntzeagatik! 💖"),
    "the_file_does_not_exist_please_ensure_it_is_located_at_file_path": m15,
    "the_github_issue": MessageLookupByLibrary.simpleMessage("Github arazoa (#143)"),
    "the_tweet_did_not_contain_any_text_this_is_unexpected": MessageLookupByLibrary.simpleMessage(
      "Txioak ez zuen testurik",
    ),
