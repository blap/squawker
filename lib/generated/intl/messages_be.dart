...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(name) => "Вы ўпэўненыя, што жадаеце выдаліць групу падпісак ${name}?";
  ...
  static String m5(snapshotData) => "Завершана праца з акаўнтамі ${snapshotData}";

  static String m6(name) => "Група: ${name}";

  static String m7(snapshotData) => "Імпартавана ${snapshotData} акаўнтаў на дадзены момант";
  ...
  static String m11(errorMessage) => "Калі ласка, праверце вашае сеткавае падлучэнне.\n\n${errorMessage}";

  static String m13(releaseVersion) => "Націсніце, каб усталяваць ${releaseVersion}";

  static String m14(getMediaType) => "Націсніце, каб паказаць ${getMediaType}";

  static String m15(filePath) => "Файл не існуе. Калі ласка, упэўніцеся, што ён знаходзіцца па адрасе ${filePath}";

  static String m16(thisTweetUserName, timeAgo) => "${thisTweetUserName} ретвітнуў(ла) ${timeAgo}";
  ...
  static String m18(widgetPlaceName) => "Немагчыма загрузіць актуальнае для ${widgetPlaceName}";

  static String m19(responseStatusCode) =>
      "Немагчыма захаваць мэдыяфайл. Twitter/X вярнуў статус ${responseStatusCode}";

  static String m20(releaseVersion) => "Абнавіць да ${releaseVersion} праз кліент F-Droid";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "activate_non_confirmation_bias_mode_description": MessageLookupByLibrary.simpleMessage(
      "Схаваць аўтораў твітаў. Пазбягайце прадузятасці пацверджання, заснаванага на аўтарытэтных аргументах.",
    ),
    ...
    "an_update_for_fritter_is_available": MessageLookupByLibrary.simpleMessage("Абнаўленне Squawker даступна! 🚀"),
    ...
    "confirm_close_fritter": MessageLookupByLibrary.simpleMessage("Вы сапраўды хочаце закрыць Squawker?"),
    ...
    "could_not_contact_twitter": MessageLookupByLibrary.simpleMessage("Не атрымоўваецца звязацца з Twitter/X"),
    ...
    "enter_your_twitter_username": MessageLookupByLibrary.simpleMessage("Увядзіце Ваша імя карыстальніка ў Twitter/X"),
    ...
    "forbidden": MessageLookupByLibrary.simpleMessage("Twitter/X кажа, што доступ да гэтага забаронены"),
    ...
    "help_make_fritter_even_better": MessageLookupByLibrary.simpleMessage("Дапамажыце зрабіць Squawker яшчэ лепш"),
    "help_support_fritters_future": MessageLookupByLibrary.simpleMessage("Падтрымайце будучыню Squawker"),
    ...
    "import_from_twitter": MessageLookupByLibrary.simpleMessage("Імпартаваць з Twitter/X"),
    ...
    "thanks_for_helping_fritter": MessageLookupByLibrary.simpleMessage("Дзякуй за дапамогу Squawker! 💖"),
    "the_file_does_not_exist_please_ensure_it_is_located_at_file_path": m15,
    "the_github_issue": MessageLookupByLibrary.simpleMessage("Прапанова GitHub (#143)"),
    ...
    "this_user_does_not_follow_anyone": MessageLookupByLibrary.simpleMessage("Гэты карыстальнік нікага не чытае!"),
