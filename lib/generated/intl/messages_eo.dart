...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(name) => "Ĉu vi certas, vi volas forigi la grupon de abonoj ${name}?";
  ...
  static String m7(snapshotData) => "${snapshotData} uzantoj importiĝis ĝis nun";
  ...
  static String m11(errorMessage) => "Bonvolu kontroli vian konekton Interretan.\n\n${errorMessage}";
  ...
  static String m15(filePath) => "La dosiero ne ekzistas. Bonvolu certigi ĝin loke ĉe ${filePath}";

  static String m16(thisTweetUserName, timeAgo) => "${thisTweetUserName} repepis ${timeAgo}";
  ...
  static String m18(widgetPlaceName) => "Ne eblas ŝarĝi la tendencaĵojn el ${widgetPlaceName}";

  static String m19(responseStatusCode) =>
      "Ne eblas konservi la plurmedion. Twitter/X revenigis staton de ${responseStatusCode}";

  static String m20(releaseVersion) => "Ĝisdatigu al ${releaseVersion} per via kliento de F-Droid";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "confirm_close_fritter": MessageLookupByLibrary.simpleMessage("Ĉu vi certas, vi volas fermi Squawker-on?"),
    ...
    "could_not_contact_twitter": MessageLookupByLibrary.simpleMessage("Ne eblas kontakti Twitter/X-on"),
    ...
    "enter_your_twitter_username": MessageLookupByLibrary.simpleMessage("Enigi vian uzantnomon de Twitter/X"),
    ...
    "forbidden": MessageLookupByLibrary.simpleMessage("Twitter/X diras, atingo estas malpermesita"),
    ...
    "help_make_fritter_even_better": MessageLookupByLibrary.simpleMessage("Helpi plibonigi Squawker-on"),
    "help_support_fritters_future": MessageLookupByLibrary.simpleMessage("Helpi subteni estontecon de Squawker"),
    ...
    "import_from_twitter": MessageLookupByLibrary.simpleMessage("Importi el Twitter/X"),
    ...
    "something_broke_in_fritter": MessageLookupByLibrary.simpleMessage("Io malfunkciis en Squawker."),
    ...
    "thanks_for_helping_fritter": MessageLookupByLibrary.simpleMessage("Dankon pro helpi Squawker! 💖"),
    "the_file_does_not_exist_please_ensure_it_is_located_at_file_path": m15,
    "the_github_issue": MessageLookupByLibrary.simpleMessage("la problemo ĉe GitHub (#143)"),
    ...
    "whether_errors_should_be_reported_to_": MessageLookupByLibrary.simpleMessage("Ĉu eraroj raportiĝus al "),
