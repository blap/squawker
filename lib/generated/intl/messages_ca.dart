...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(name) => "Estàs segur que vols suprimir el grup de subscripcions ${name}?";
  ...
  static String m11(errorMessage) => "Comprova la connexió a Internet.\n\n${errorMessage}";

  static String m13(releaseVersion) => "Fes un toc per descarregar ${releaseVersion}";

  static String m14(getMediaType) => "Fes un toc per mostrar ${getMediaType}";

  static String m15(filePath) => "El fitxer no existeix. Assegureu-vos que es troba a ${filePath}";

  static String m16(thisTweetUserName, timeAgo) => "${thisTweetUserName} retuitejat ${timeAgo}";
  ...
  static String m18(widgetPlaceName) => "No s\'han pogut carregar les tendències per ${widgetPlaceName}";

  static String m19(responseStatusCode) =>
      "No s\'ha pogut desar el suport. Twitter/X ha retornat un estat de ${responseStatusCode}";

  static String m20(releaseVersion) => "Actualitza-ho a ${releaseVersion} a través del client de F-Droid";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "confirm_close_fritter": MessageLookupByLibrary.simpleMessage("Segur que vols tancar Squawker?"),
    ...
    "could_not_contact_twitter": MessageLookupByLibrary.simpleMessage("No s\'ha pogut contactar amb Twitter/X"),
    ...
    "enter_your_twitter_username": MessageLookupByLibrary.simpleMessage("Introdeix el teu nom d\'usuari de Twitter/X"),
    ...
    "forbidden": MessageLookupByLibrary.simpleMessage("El Twitter/X diu que l\'accés a això està prohibit"),
    ...
    "help_support_fritters_future": MessageLookupByLibrary.simpleMessage("Ajuda a donar suport al futur de Squawker"),
    ...
    "something_broke_in_fritter": MessageLookupByLibrary.simpleMessage("S\'ha trencat alguna cosa a Squawker."),
    ...
    "thanks_for_helping_fritter": MessageLookupByLibrary.simpleMessage("Gràcies per ajudar a Squawker! 💖"),
