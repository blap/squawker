...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(name) => "¿Está seguro de que desea eliminar la suscripción a ${name}?";

  static String m1(fileName) => "Datos exportados a ${fileName}";

  static String m2(fullPath) => "Datos exportados a ${fullPath}";

  static String m5(snapshotData) => "Terminado con los usuarios  ${snapshotData}";

  static String m8(date) => "Se unió ${date}";

  static String m15(filePath) => "El archivo no existe. Por favor, asegúrese de que se encuentra en ${filePath}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "app_info": MessageLookupByLibrary.simpleMessage("Información de la aplicación"),
    ...
    "copied_address_to_clipboard": MessageLookupByLibrary.simpleMessage("Dirección copiada en el portapapeles"),
    "copied_version_to_clipboard": MessageLookupByLibrary.simpleMessage("Versión copiada al portapapeles"),
    ...
    "data_imported_successfully": MessageLookupByLibrary.simpleMessage("Datos importados correctamente"),
    "date_created": MessageLookupByLibrary.simpleMessage("Fecha creada"),
    "date_subscribed": MessageLookupByLibrary.simpleMessage("Fecha de Subscripción"),
    ...
    "enter_your_twitter_username": MessageLookupByLibrary.simpleMessage("Ingresa tu usuario de Twitter/X"),
    "export": MessageLookupByLibrary.simpleMessage("Exportar"),
    "export_guest_accounts": MessageLookupByLibrary.simpleMessage("¿Exportar cuentas de invitados?"),
    "export_settings": MessageLookupByLibrary.simpleMessage("¿Exportar configuración?"),
    "export_subscription_group_members": MessageLookupByLibrary.simpleMessage(
      "¿Exportar miembros de grupos de suscripción?",
    ),
    "export_subscription_groups": MessageLookupByLibrary.simpleMessage("¿Exportar grupos de suscripciones?"),
    "export_subscriptions": MessageLookupByLibrary.simpleMessage("¿Exportar las suscripciones?"),
    "export_tweets": MessageLookupByLibrary.simpleMessage("¿Exportar Tweets?"),
    "export_your_data": MessageLookupByLibrary.simpleMessage("Exportar sus datos"),
    ...
    "help_make_fritter_even_better": MessageLookupByLibrary.simpleMessage("Ayuda a qué Squawker sea aún mejor"),
    "help_support_fritters_future": MessageLookupByLibrary.simpleMessage("Ayuda al futuro de Squawker"),
    ...
    "import_data_from_another_device": MessageLookupByLibrary.simpleMessage("Importar datos desde otro dispositivo"),
    "import_from_twitter": MessageLookupByLibrary.simpleMessage("Importar de Twitter/X"),
    "import_subscriptions": MessageLookupByLibrary.simpleMessage("Importar suscripciones"),
    ...
    "legacy_android_import": MessageLookupByLibrary.simpleMessage("Importación desde Android antiguo"),
    ...
    "no_results_for": MessageLookupByLibrary.simpleMessage("Sin resultados para:"),
    ...
    "please_enter_a_name": MessageLookupByLibrary.simpleMessage("Por favor, introduce un nombre"),
    ...
    "released_under_the_mit_license": MessageLookupByLibrary.simpleMessage("Publicado bajo la licencia MIT"),
    ...
    "thanks_for_helping_fritter": MessageLookupByLibrary.simpleMessage("Gracias por ayudar a Squawker! 💖"),
    "the_file_does_not_exist_please_ensure_it_is_located_at_file_path": m15,
    "the_github_issue": MessageLookupByLibrary.simpleMessage("El problema de GitHub (#143)"),
    ...
    "tweets_and_replies": MessageLookupByLibrary.simpleMessage("Tweets & Respuestas"),
    ...
    "unable_to_import": MessageLookupByLibrary.simpleMessage("La importación no se ha podido realizar"),
    ...
    "unable_to_load_the_profile": MessageLookupByLibrary.simpleMessage("No se puede cargar el perfil"),
    ...
    "unable_to_load_the_tweets": MessageLookupByLibrary.simpleMessage("No se pueden cargar los tuits"),
    ...
    "whether_errors_should_be_reported_to_": MessageLookupByLibrary.simpleMessage("Los errores se deben informar a "),
