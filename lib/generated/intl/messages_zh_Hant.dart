...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m16(thisTweetUserName, timeAgo) => "${thisTweetUserName} 於 ${timeAgo} 前轉推了";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "could_not_find_any_tweets_by_this_user": MessageLookupByLibrary.simpleMessage("找不到這個使用者的任何推文！"),
    "could_not_find_any_tweets_from_the_last_7_days": MessageLookupByLibrary.simpleMessage("找不到過去 7 天的推文！"),
    "country": MessageLookupByLibrary.simpleMessage("國家"),
    "dark": MessageLookupByLibrary.simpleMessage("深色"),
    "data": MessageLookupByLibrary.simpleMessage("資料"),
    "data_imported_successfully": MessageLookupByLibrary.simpleMessage("資料匯入成功"),
    ...
    "download_handling_type_directory": MessageLookupByLibrary.simpleMessage("儲存至目錄"),
    "download_media_no_url": MessageLookupByLibrary.simpleMessage("無法下載。此媒體可能僅以串流形式提供，而 Squawker 尚無法下載。"),
    ...
    "error_from_twitter": MessageLookupByLibrary.simpleMessage("來自 Twitter／X 的錯誤"),
    ...
    "export_subscription_groups": MessageLookupByLibrary.simpleMessage("匯出訂閱群組？"),
    "export_subscriptions": MessageLookupByLibrary.simpleMessage("匯出訂閱？"),
    "export_tweets": MessageLookupByLibrary.simpleMessage("匯出推文？"),
    "export_twitter_tokens": MessageLookupByLibrary.simpleMessage("匯出 Twitter／X 令牌？"),
    ...
    "import_from_twitter": MessageLookupByLibrary.simpleMessage("從 Twitter／X 匯入"),
    ...
    "legacy_android_import": MessageLookupByLibrary.simpleMessage("舊版 Android 匯入"),
    ...
    "option_navigation_animations_label": MessageLookupByLibrary.simpleMessage("導航動畫"),
    ...
    "please_note_that_the_method_fritter_uses_to_import_subscriptions_is_heavily_rate_limited_by_twitter_so_this_may_fail_if_you_have_a_lot_of_followed_accounts":
        MessageLookupByLibrary.simpleMessage("請注意，Squawker 使用的訂閱匯入方法受限於 Twitter/X 的速率限制，因此如果您關注了大量帳戶，這可能會失敗。"),
    "possibly_sensitive": MessageLookupByLibrary.simpleMessage("潛在敏感"),
    "possibly_sensitive_profile": MessageLookupByLibrary.simpleMessage("此設定檔可能包含潛在敏感的圖片、語言或其他內容。您是否仍然想要查看？"),
    ...
    "saved_tweet_too_large": MessageLookupByLibrary.simpleMessage("此已儲存的推文無法顯示，因為內容過大無法載入。請向開發者回報此問題。"),
    ...
    "should_check_for_updates_label": MessageLookupByLibrary.simpleMessage("檢查更新"),
    ...
    "successfully_saved_the_media": MessageLookupByLibrary.simpleMessage("已儲存媒體！"),
    ...
    "this_group_contains_no_subscriptions": MessageLookupByLibrary.simpleMessage("這個群組不包含訂閱！"),
    ...
    "this_user_does_not_follow_anyone": MessageLookupByLibrary.simpleMessage("這個使用者沒有關注任何人！"),
    ...
    "unable_to_find_your_saved_tweets": MessageLookupByLibrary.simpleMessage("無法找到你已儲存的推文。"),
    "unable_to_import": MessageLookupByLibrary.simpleMessage("無法匯入"),
    "unable_to_load_subscription_groups": MessageLookupByLibrary.simpleMessage("無法載入訂閱群組"),
    "unable_to_load_the_group": MessageLookupByLibrary.simpleMessage("無法載入群組"),
    "unable_to_load_the_group_settings": MessageLookupByLibrary.simpleMessage("無法載入群組設定"),
    "unable_to_load_the_list_of_follows": MessageLookupByLibrary.simpleMessage("無法載入關注列表"),
    "unable_to_load_the_next_page_of_follows": MessageLookupByLibrary.simpleMessage("無法載入下一頁的關注列表"),
    "unable_to_load_the_next_page_of_replies": MessageLookupByLibrary.simpleMessage("無法載入下一頁的回覆"),
    "unable_to_load_the_next_page_of_tweets": MessageLookupByLibrary.simpleMessage("無法載入下一頁的推文"),
    "unable_to_load_the_search_results": MessageLookupByLibrary.simpleMessage("無法載入搜尋結果。"),
    ...
    "would_you_like_to_enable_automatic_error_reporting": MessageLookupByLibrary.simpleMessage("你想啟用自動錯誤回報嗎？"),
    "x_api": MessageLookupByLibrary.simpleMessage("X API"),
    "yes": MessageLookupByLibrary.simpleMessage("是"),
    "yes_please": MessageLookupByLibrary.simpleMessage("是的，請"),
    "you_have_not_saved_any_tweets_yet": MessageLookupByLibrary.simpleMessage("你還沒有儲存任何推文！"),
