...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m16(thisTweetUserName, timeAgo) => "${thisTweetUserName}がリツイート ${timeAgo}";
  ...
  static String m19(responseStatusCode) => "メディアを保存できませんでした。Twitter/Xから返されたステータス：${responseStatusCode}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "all_the_great_software_used_by_fritter": MessageLookupByLibrary.simpleMessage("Squawkerで使用する偉大なソフトウェア"),
    "an_update_for_fritter_is_available": MessageLookupByLibrary.simpleMessage("Squawkerの更新が利用可能です！🚀"),
    "are_you_sure": MessageLookupByLibrary.simpleMessage("確認"),
    "are_you_sure_you_want_to_delete_the_subscription_group_name_of_group": m0,
    "back": MessageLookupByLibrary.simpleMessage("戻る"),
    "blue_theme_based_on_the_twitter_color_scheme": MessageLookupByLibrary.simpleMessage("Twitter/Xの配色に基づいたブルーのテーマ"),
    ...
    "confirm_close_fritter": MessageLookupByLibrary.simpleMessage("Squawker を閉じますか？"),
    ...
    "could_not_contact_twitter": MessageLookupByLibrary.simpleMessage("Twitter/Xにアクセスできませんでした"),
    ...
    "enter_your_twitter_username": MessageLookupByLibrary.simpleMessage("Twitter/Xユーザ名を入力"),
    ...
    "help_make_fritter_even_better": MessageLookupByLibrary.simpleMessage("Squawkerを改善するために協力する"),
    "help_support_fritters_future": MessageLookupByLibrary.simpleMessage("Squawkerの将来を支援する"),
    ...
    "import_from_twitter": MessageLookupByLibrary.simpleMessage("Twitter/Xからインポート"),
    ...
    "page_not_found": MessageLookupByLibrary.simpleMessage("Twitter/Xはページがないと表示しているが、本当ではないかもしれない"),
    ...
    "should_check_for_updates_description": MessageLookupByLibrary.simpleMessage("Squawker開始時に更新を確認する"),
    "should_check_for_updates_label": MessageLookupByLibrary.simpleMessage("更新を確認"),
    "small": MessageLookupByLibrary.simpleMessage("小"),
    "something_broke_in_fritter": MessageLookupByLibrary.simpleMessage("Squawkerに異常が発生しました。"),
    ...
    "thanks_for_helping_fritter": MessageLookupByLibrary.simpleMessage("Squawkerを支援いただきありがとうございます！💖"),
    "the_file_does_not_exist_please_ensure_it_is_located_at_file_path": m15,
    "the_github_issue": MessageLookupByLibrary.simpleMessage("GitHub issue (#143)"),
    "the_tweet_did_not_contain_any_text_this_is_unexpected": MessageLookupByLibrary.simpleMessage(
      "ツイートのテキストがありません。予期せぬ結果です",
    ),
    ...
    "to_import_subscriptions_from_an_existing_twitter_account_enter_your_username_below":
        MessageLookupByLibrary.simpleMessage("Twitter/Xアカウントから登録アカウントをインポートするには、以下にユーザ名を入力してください。"),
