...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(snapshotData) => "${snapshotData} المستخدمين المستوردين حتى الآن";
  ...
  static String m11(errorMessage) => "رجائاً تحقق من اتصال الشبكة لديك.\n\n${errorMessage}";

  static String m12(nbrRegularAccounts) => "الحسابات العادية (${nbrRegularAccounts}):";

  static String m13(releaseVersion) => "انقر للتحميل ${releaseVersion}";

  static String m14(getMediaType) => "انقر للعرض ${getMediaType}";

  static String m15(filePath) => "الملف غير موجود. رجائاً تأكد أنه موجو في ${filePath}";

  static String m16(thisTweetUserName, timeAgo) => "${thisTweetUserName} أعاد تغريد ${timeAgo}";
  ...
  static String m18(widgetPlaceName) => "غير قادر على تحميل الترندات لـ${widgetPlaceName}";

  static String m19(responseStatusCode) => "تعذر حفظ الوسائط. أعاد تويتر حالة ${responseStatusCode}";

  static String m20(releaseVersion) => "حدّث إلى ${releaseVersion} عبر عميل الـF-Droid لديك";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "allow_background_play_description": MessageLookupByLibrary.simpleMessage("السماح بالتشغيل في الخلفية"),
    "allow_background_play_label": MessageLookupByLibrary.simpleMessage("التشغيل في الخلفية"),
    ...
    "allow_background_play_other_apps_label": MessageLookupByLibrary.simpleMessage("تطبيقات أخرى في الخلفية"),
    "an_update_for_fritter_is_available": MessageLookupByLibrary.simpleMessage("هناك تحديث متوفر لـ Squawker! 🚀"),
    ...
    "community_notes_title": MessageLookupByLibrary.simpleMessage("القراء أضافوا السياق"),
    "confirm_close_fritter": MessageLookupByLibrary.simpleMessage("هل أنت متأكد من أنك تريد إغلاق Squawker؟"),
    ...
    "default_subscription_tab": MessageLookupByLibrary.simpleMessage("علامة تبويب الاشتراك الافتراضية"),
    ...
    "download_video_best_quality_label": MessageLookupByLibrary.simpleMessage("قم بتنزيل مقاطع الفيديو بأفضل جودة"),
    ...
    "enhanced_feeds_label": MessageLookupByLibrary.simpleMessage("خلاصات محسنة"),
    "enhanced_profile_description": MessageLookupByLibrary.simpleMessage("طلبات محسنة للملف الشخصي"),
    "enhanced_profile_label": MessageLookupByLibrary.simpleMessage("ملف تعريف مُحسّن"),
    "enhanced_searches_description": MessageLookupByLibrary.simpleMessage(
      "طلبات محسنة لعمليات البحث (ولكن مع حدود معدل أقل)",
    ),
    "enhanced_searches_label": MessageLookupByLibrary.simpleMessage("عمليات البحث المحسنة"),
    ...
    "error_from_twitter": MessageLookupByLibrary.simpleMessage("خطأ من تويتر/X"),
    "exclusions_feed_description": MessageLookupByLibrary.simpleMessage(
      "قائمة بأسماء المستخدمين المراد استبعادها من التغذية",
    ),
    "exclusions_feed_label": MessageLookupByLibrary.simpleMessage("استثناءات في التغذية"),
    "export": MessageLookupByLibrary.simpleMessage("تصدير"),
    "export_guest_accounts": MessageLookupByLibrary.simpleMessage("تصدير حسابات الضيوف؟"),
    "export_settings": MessageLookupByLibrary.simpleMessage("تصدير الإعدادات؟"),
    "export_subscription_group_members": MessageLookupByLibrary.simpleMessage("تصدير أعضاء مجموعات الاشتراكات؟"),
    ...
    "export_twitter_tokens": MessageLookupByLibrary.simpleMessage("هل تريد تصدير رمز الجلسة Twitter/X؟"),
    ...
    "help_make_fritter_even_better": MessageLookupByLibrary.simpleMessage("المساعدة في جعل Squawker أفضل"),
    "help_support_fritters_future": MessageLookupByLibrary.simpleMessage("المساعدة على دعم تطوير Squawker"),
    ...
    "include_retweets": MessageLookupByLibrary.simpleMessage("تضمين التغريدات المعاد نشرها"),
    "joined": m8,
    ...
    "keep_feed_offset_label": MessageLookupByLibrary.simpleMessage("حافظ على موازنة الخلاصات"),
    ...
    "leaner_feeds_description": MessageLookupByLibrary.simpleMessage("لا تظهر روابط المعاينة في التغريدات من الخلاصات"),
    ...
    "libre_translate_host": MessageLookupByLibrary.simpleMessage("مضيف LibreTranslate"),
    ...
    "mandatory_label": MessageLookupByLibrary.simpleMessage("الميادين الإلزامية:"),
    ...
    "option_confirm_close_description": MessageLookupByLibrary.simpleMessage("قم بالتأكيد عند إغلاق التطبيق"),
    "option_confirm_close_label": MessageLookupByLibrary.simpleMessage("تأكيد الإغلاق"),
    "option_navigation_animations_description": MessageLookupByLibrary.simpleMessage("تمكين تأثيرات التنقل"),
    "option_navigation_animations_label": MessageLookupByLibrary.simpleMessage("تأثيرات التنقل"),
    "option_show_navigation_labels_description": MessageLookupByLibrary.simpleMessage(
      "إظهار التسميات من أيقونات شريط التنقل",
    ),
    "option_show_navigation_labels_label": MessageLookupByLibrary.simpleMessage("تسميات شريط التنقل"),
    "optional_label": MessageLookupByLibrary.simpleMessage("الحقول الاختيارية:"),
    ...
    "proxy_description": MessageLookupByLibrary.simpleMessage("الوكيل لجميع الطلبات"),
    ...
    "share_tweet_as_image": MessageLookupByLibrary.simpleMessage("مشاركة التغريدة كصورة"),
    ...
    "something_broke_in_fritter": MessageLookupByLibrary.simpleMessage("حدث خطأ ما في Squawker."),
    ...
    "thanks_for_helping_fritter": MessageLookupByLibrary.simpleMessage("شكراً على مساعدتك لـ Squawker! 💖"),
    "the_file_does_not_exist_please_ensure_it_is_located_at_file_path": m15,
    "the_github_issue": MessageLookupByLibrary.simpleMessage("مشكلة جيثب (# 143)"),
    ...
    "this_group_contains_no_subscriptions": MessageLookupByLibrary.simpleMessage("هذه المجموعة لا تحتوي على اشتراكات!"),
    ...
    "thumbnail_not_available": MessageLookupByLibrary.simpleMessage("المعاينة غير متوفرة"),
    ...
    "translators_description": MessageLookupByLibrary.simpleMessage("استخدم مثيلات LibreTranslate المخصصة"),
    ...
    "tweet_font_size_description": MessageLookupByLibrary.simpleMessage("حجم خط التغريدات"),
    ...
    "tweets_number": m17,
    "twitter_account_types_both": MessageLookupByLibrary.simpleMessage("ضيف وعادي"),
    "twitter_account_types_description": MessageLookupByLibrary.simpleMessage("نوع الحساب المستخدم"),
    "twitter_account_types_label": MessageLookupByLibrary.simpleMessage("نوع الحساب"),
    "twitter_account_types_only_regular": MessageLookupByLibrary.simpleMessage("عادي فقط"),
    "twitter_account_types_priority_to_regular": MessageLookupByLibrary.simpleMessage("الأولويات العادية"),
    ...
    "unable_to_load_subscription_groups": MessageLookupByLibrary.simpleMessage("تعذّر تحميل مجموعات الاشتراك"),
    "unable_to_load_the_group": MessageLookupByLibrary.simpleMessage("تعذّر تحميل المجموعة"),
    ...
    "unable_to_load_the_profile": MessageLookupByLibrary.simpleMessage("تعذّر تحميل الملف الشخصي"),
    ...
    "unable_to_load_the_tweet": MessageLookupByLibrary.simpleMessage("تعذّر تحميل التغريدات"),
    "unable_to_load_the_tweets": MessageLookupByLibrary.simpleMessage("تعذّر تحميل التغريدات"),
    ...
    "username_exclude": MessageLookupByLibrary.simpleMessage("اسم المستخدم المراد استبعاده"),
    ...
    "which_tab_is_shown_when_the_app_opens": MessageLookupByLibrary.simpleMessage("أي لسان سيظهر عندما يفتح التطبيق"),
