...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(name) => "Biztos benne, hogy letörli a ${name} feliratkozási csoportot?";
  ...
  static String m5(snapshotData) => "${snapshotData} felhasználó sikeresen importálva";
  ...
  static String m9(nbrGuestAccounts) => "Jelenleg ${nbrGuestAccounts} vendég fiók van";
  ...
  static String m11(errorMessage) => "Ellenőrizze internet kapcsolatát.\n\n${errorMessage}";

  static String m12(nbrRegularAccounts) => "Sima fiók (${nbrRegularAccounts}):";

  static String m13(releaseVersion) => "Nyomjon rá a ${releaseVersion} letöltéséhez";

  static String m14(getMediaType) => "Nyomjon rá, hogy látszódjon a ${getMediaType}";

  static String m15(filePath) => "A fájl nem létezik. Győződjön meg róla, hogy a ${filePath} helyen található";

  static String m16(thisTweetUserName, timeAgo) => "${thisTweetUserName} újratweetelte ${timeAgo} idővel ezelőtt";
  ...
  static String m18(widgetPlaceName) => "Nem tölthetőek be a trendek a ${widgetPlaceName}-hez";

  static String m19(responseStatusCode) => "Média nem menthető. A Twitter/X ${responseStatusCode} kódú hibát adott.";

  static String m20(releaseVersion) => "Frissítsen a ${releaseVersion} verzióra az F-Droid kliensben";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "account_suspended": MessageLookupByLibrary.simpleMessage("Fiók felfüggesztve"),
    ...
    "add_account_title": MessageLookupByLibrary.simpleMessage("Fiók hozzáadása"),
    "add_subscriptions": MessageLookupByLibrary.simpleMessage("Feliratkozás hozzáadása"),
    "add_to_feed": MessageLookupByLibrary.simpleMessage("Hozzáadás hírfolyamhoz"),
    "add_to_group": MessageLookupByLibrary.simpleMessage("Hozzáadás csoporthoz"),
    ...
    "allow_background_play_description": MessageLookupByLibrary.simpleMessage("Háttérben lejátszás engedélyezése"),
    "allow_background_play_label": MessageLookupByLibrary.simpleMessage("Lejátszás a háttérben"),
    ...
    "allow_background_play_other_apps_label": MessageLookupByLibrary.simpleMessage("Más appok a háttérben"),
    "an_update_for_fritter_is_available": MessageLookupByLibrary.simpleMessage("Frissítés elérhető a Squawker-hez! 🚀"),
    ...
    "catastrophic_failure": MessageLookupByLibrary.simpleMessage("Katasztrofális hiba"),
    ...
    "confirm_close_fritter": MessageLookupByLibrary.simpleMessage("Biztos benne, hogy be akarja zárni a Squawker-t?"),
    "contribute": MessageLookupByLibrary.simpleMessage("Hozzájárulás"),
    "copied_address_to_clipboard": MessageLookupByLibrary.simpleMessage("Cím másolva a vágólapra"),
    "copied_version_to_clipboard": MessageLookupByLibrary.simpleMessage("Verzió a vágólapra másolva"),
    "could_not_contact_twitter": MessageLookupByLibrary.simpleMessage("Nem elérhető a Twitter/X"),
    ...
    "data_imported_successfully": MessageLookupByLibrary.simpleMessage("Adatok sikeresen importálásra kerültek"),
    "date_created": MessageLookupByLibrary.simpleMessage("Létrehozási Dátum"),
    "date_subscribed": MessageLookupByLibrary.simpleMessage("Feliratkozási Dátum"),
    "default_subscription_tab": MessageLookupByLibrary.simpleMessage("Alap feliratkozási fül"),
    "default_tab": MessageLookupByLibrary.simpleMessage("Alap fül"),
    "delete": MessageLookupByLibrary.simpleMessage("Törlés"),
    "disable_screenshots": MessageLookupByLibrary.simpleMessage("Képernyőkép tiltása"),
    ...
    "download_handling": MessageLookupByLibrary.simpleMessage("Kezelés letöltése"),
    "download_handling_description": MessageLookupByLibrary.simpleMessage("Ahogyan a letöltésnek működnie kéne"),
    "download_handling_type_ask": MessageLookupByLibrary.simpleMessage("Mindig rákérdez"),
    "download_handling_type_directory": MessageLookupByLibrary.simpleMessage("Mentés könyvtárba"),
    ...
    "download_video_best_quality_label": MessageLookupByLibrary.simpleMessage("Videók letöltése a legjobb minőségben"),
    "downloading_media": MessageLookupByLibrary.simpleMessage("Média letöltése..."),
    "edit_account_title": MessageLookupByLibrary.simpleMessage("Fiók módosítása"),
    ...
    "enhanced_feeds_label": MessageLookupByLibrary.simpleMessage("Javított hírfolyamok"),
    "enhanced_profile_description": MessageLookupByLibrary.simpleMessage("Javított kérések a profilhoz"),
    "enhanced_profile_label": MessageLookupByLibrary.simpleMessage("Javított profil"),
    ...
    "enhanced_searches_label": MessageLookupByLibrary.simpleMessage("Javított keresések"),
    ...
    "enter_your_twitter_username": MessageLookupByLibrary.simpleMessage("Adja meg Twitter/X felhasználónevét"),
    "error_from_twitter": MessageLookupByLibrary.simpleMessage("Twitter/X hiba"),
    "exclusions_feed_description": MessageLookupByLibrary.simpleMessage(
      "A hírfolyamról kizárt felhasználónevek listája",
    ),
    "exclusions_feed_label": MessageLookupByLibrary.simpleMessage("Kivételek a hírfolyamban"),
    "export": MessageLookupByLibrary.simpleMessage("Exportálás"),
    "export_guest_accounts": MessageLookupByLibrary.simpleMessage("Exportálni akarja a vendég fiókokat?"),
    "export_settings": MessageLookupByLibrary.simpleMessage("Beállítások exportálása?"),
    ...
    "export_subscriptions": MessageLookupByLibrary.simpleMessage("Feliratkozások exportálása?"),
    "export_tweets": MessageLookupByLibrary.simpleMessage("Exportálni kívánja a tweet-eket?"),
    "export_twitter_tokens": MessageLookupByLibrary.simpleMessage("Twitter/X tokenek exportálása?"),
    "export_your_data": MessageLookupByLibrary.simpleMessage("Adatai exportálása"),
    ...
    "forbidden": MessageLookupByLibrary.simpleMessage("A Twitter/X szerint ennek elérése tiltott"),
    "fritter": MessageLookupByLibrary.simpleMessage("Squawker"),
    "fritter_blue": MessageLookupByLibrary.simpleMessage("Squawker kék"),
    "functionality_unsupported": MessageLookupByLibrary.simpleMessage("Ez a funkciót többé nem támogatja a Twitter/X!"),
    ...
    "help_make_fritter_even_better": MessageLookupByLibrary.simpleMessage("Tedd még jobbá a Squawker-t"),
    "help_support_fritters_future": MessageLookupByLibrary.simpleMessage("Támogassa a Squawker jövőjét"),
    "hide_sensitive_tweets": MessageLookupByLibrary.simpleMessage("Érzékeny tweet-ek elrejtése"),
    ...
    "import_data_from_another_device": MessageLookupByLibrary.simpleMessage("Adat importálása egy másik eszközről"),
    "import_from_twitter": MessageLookupByLibrary.simpleMessage("Importálás Twitter/X-ről"),
    "import_subscriptions": MessageLookupByLibrary.simpleMessage("Feliratkozások Importálása"),
    "imported_snapshot_data_users_so_far": m7,
    "include_replies": MessageLookupByLibrary.simpleMessage("Válaszok mutatása"),
    "include_retweets": MessageLookupByLibrary.simpleMessage("Retweet-ek mutatása"),
    "joined": m8,
    ...
    "keep_feed_offset_label": MessageLookupByLibrary.simpleMessage("Legyenek eltolva a hírfolyamok"),
    "language": MessageLookupByLibrary.simpleMessage("Nyelv"),
    "language_subtitle": MessageLookupByLibrary.simpleMessage("Újraindítás szükséges"),
    ...
    "leaner_feeds_label": MessageLookupByLibrary.simpleMessage("Vékony hírfolyamok"),
    "legacy_android_import": MessageLookupByLibrary.simpleMessage("Régi típusú Android import"),
    ...
    "mandatory_label": MessageLookupByLibrary.simpleMessage("Kitöltendő rubrikák:"),
    ...
    "mute_video_description": MessageLookupByLibrary.simpleMessage("Némítva induljanak e el a videók alapból"),
    ...
    "no_results_for": MessageLookupByLibrary.simpleMessage("Nincs találat a következőre:"),
    ...
    "oops_something_went_wrong": MessageLookupByLibrary.simpleMessage("Hoppá! Valami hiba történt 🥲"),
    "open_app_settings": MessageLookupByLibrary.simpleMessage("App beállítások megnyitása"),
    "open_in_browser": MessageLookupByLibrary.simpleMessage("Megnyitás böngszőben"),
    "option_confirm_close_description": MessageLookupByLibrary.simpleMessage("App bezárás megerősítése"),
    "option_confirm_close_label": MessageLookupByLibrary.simpleMessage("Bezárás megerősítése"),
    "optional_label": MessageLookupByLibrary.simpleMessage("Kitölthető rubrikák:"),
    ...
    "pick_a_color": MessageLookupByLibrary.simpleMessage("Válasszon egy színt!"),
    "pick_an_icon": MessageLookupByLibrary.simpleMessage("Válasszon egy ikont!"),
    "pinned_tweet": MessageLookupByLibrary.simpleMessage("Kitűzött tweet"),
    "playback_speed": MessageLookupByLibrary.simpleMessage("Visszajátszási sebesség"),
    "please_check_your_internet_connection_error_message": m11,
    "please_enter_a_name": MessageLookupByLibrary.simpleMessage("Kérem adjon meg egy nevet"),
    ...
    "possibly_sensitive": MessageLookupByLibrary.simpleMessage("Potenciálisan érzékeny"),
    ...
    "proxy_description": MessageLookupByLibrary.simpleMessage("Proxy minden kérés esetén"),
    ...
    "released_under_the_mit_license": MessageLookupByLibrary.simpleMessage("Megjelenés az MIT Licensz alatt"),
    "remove_from_feed": MessageLookupByLibrary.simpleMessage("Eltávolítás a hírfolyamból"),
    "replying_to": MessageLookupByLibrary.simpleMessage("Válasz a következőnek"),
    "report": MessageLookupByLibrary.simpleMessage("Jelentés"),
    "report_a_bug": MessageLookupByLibrary.simpleMessage("Bug jelentése"),
    "reporting_an_error": MessageLookupByLibrary.simpleMessage("Hiba bejelentése"),
    "reset_home_pages": MessageLookupByLibrary.simpleMessage("Oldalak visszaállítása alapra"),
    "retry": MessageLookupByLibrary.simpleMessage("Újra"),
    "save": MessageLookupByLibrary.simpleMessage("Mentés"),
    "save_bandwidth_using_smaller_images": MessageLookupByLibrary.simpleMessage("Sávszél megtakarítás kisebb képekkel"),
    ...
    "share_base_url": MessageLookupByLibrary.simpleMessage("Egyéni megosztási URL"),
    "share_base_url_description": MessageLookupByLibrary.simpleMessage("Egyéni alapú URL használata megosztásnál"),
    "share_tweet_as_image": MessageLookupByLibrary.simpleMessage("Tweet megosztása képként"),
    "share_tweet_content": MessageLookupByLibrary.simpleMessage("Tweet tartalom megosztása"),
    "share_tweet_content_and_link": MessageLookupByLibrary.simpleMessage("Tweet tartalom és link megosztása"),
    "share_tweet_link": MessageLookupByLibrary.simpleMessage("Tweet link megosztása"),
    "should_check_for_updates_description": MessageLookupByLibrary.simpleMessage(
      "Frissítések keresése a Squawker indulásakor",
    ),
    "should_check_for_updates_label": MessageLookupByLibrary.simpleMessage("Frissítések keresése"),
    "small": MessageLookupByLibrary.simpleMessage("Kicsi"),
    "something_broke_in_fritter": MessageLookupByLibrary.simpleMessage("Valami hiba lépett fel a Squawker-ben."),
    ...
    "successfully_saved_the_media": MessageLookupByLibrary.simpleMessage("Média lementve!"),
    ...
    "thanks_for_helping_fritter": MessageLookupByLibrary.simpleMessage("Köszönjük, hogy segít a Squawker-nek! 💖"),
    "the_file_does_not_exist_please_ensure_it_is_located_at_file_path": m15,
    "the_github_issue": MessageLookupByLibrary.simpleMessage("GitHub-os probléma (#143)"),
    ...
    "this_user_does_not_follow_anyone": MessageLookupByLibrary.simpleMessage("Ez a felhasználó nem követ senkit!"),
    ...
    "thumbnail_not_available": MessageLookupByLibrary.simpleMessage("Előkép nem elérhető"),
    ...
    "tweet_font_size_description": MessageLookupByLibrary.simpleMessage("Tweet-ek betű mérete"),
    ...
    "tweets_and_replies": MessageLookupByLibrary.simpleMessage("Tweet-ek & válaszok"),
    "tweets_number": m17,
    "twitter_account_types_both": MessageLookupByLibrary.simpleMessage("Vendég és sima"),
    "twitter_account_types_description": MessageLookupByLibrary.simpleMessage("Fiók típus használata"),
    "twitter_account_types_label": MessageLookupByLibrary.simpleMessage("Fiók típus"),
    "twitter_account_types_only_regular": MessageLookupByLibrary.simpleMessage("Csak sima"),
    "twitter_account_types_priority_to_regular": MessageLookupByLibrary.simpleMessage("Sima előnyben részesítése"),
    "two_home_pages_required": MessageLookupByLibrary.simpleMessage("Kell legyen legalább kettő kezdőlapja."),
    ...
    "unable_to_find_your_saved_tweets": MessageLookupByLibrary.simpleMessage("Nem találhatóak mentett tweet-ek."),
    "unable_to_import": MessageLookupByLibrary.simpleMessage("Sikertelen importálás"),
    "unable_to_load_home_pages": MessageLookupByLibrary.simpleMessage("Nem tölthetőek be a kezdőlapjai"),
    ...
    "unable_to_load_the_group": MessageLookupByLibrary.simpleMessage("A csoport nem tölthető be"),
    "unable_to_load_the_group_settings": MessageLookupByLibrary.simpleMessage(
      "A csoport beállítások nem tölthetőek be",
    ),
    "unable_to_load_the_list_of_follows": MessageLookupByLibrary.simpleMessage("Nem tölthető be a követők listája"),
    ...
    "unable_to_load_the_profile": MessageLookupByLibrary.simpleMessage("Profil nem tölthető be"),
    "unable_to_load_the_search_results": MessageLookupByLibrary.simpleMessage("Keresési eredmények nem tölthetőek be."),
    "unable_to_load_the_trends_for_widget_place_name": m18,
    "unable_to_load_the_tweet": MessageLookupByLibrary.simpleMessage("Nem sikerült betölteni a tweet-et"),
    "unable_to_load_the_tweets": MessageLookupByLibrary.simpleMessage("Tweet-ek nem tölthetőek be"),
    ...
    "unable_to_refresh_the_subscriptions": MessageLookupByLibrary.simpleMessage("Nem frissíthetőek a feliratkozások"),
    ...
    "unsupported_url": MessageLookupByLibrary.simpleMessage("Nem támogatott URL"),
    ...
    "user_not_found": MessageLookupByLibrary.simpleMessage("Felhasználó nem található"),
    "username": MessageLookupByLibrary.simpleMessage("Felhasználónév"),
    "username_exclude": MessageLookupByLibrary.simpleMessage("Kizárt felhasználónév"),
    ...
    "when_a_new_app_update_is_available": MessageLookupByLibrary.simpleMessage("Amikor egy új app frissítés elérhető"),
    ...
    "you_have_not_saved_any_tweets_yet": MessageLookupByLibrary.simpleMessage("Nem mentett el eddig tweet-eket!"),
