...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(snapshotData) => "Zatím importováno ${snapshotData} uživatelů";
  ...
  static String m11(errorMessage) => "Zkontrolujte prosím vaše připojení k internetu.\n\n${errorMessage}";
  ...
  static String m15(filePath) => "Soubor neexistuje. Ujistěte se, že se nachází v ${filePath}";

  static String m16(thisTweetUserName, timeAgo) => "${thisTweetUserName} retweetnul ${timeAgo}";
  ...
  static String m18(widgetPlaceName) => "Nepodařilo se načíst trendy pro ${widgetPlaceName}";

  static String m19(responseStatusCode) => "Nepodařilo se uložit média. Twitter/X vrátil stav ${responseStatusCode}";

  static String m20(releaseVersion) => "Aktualizovat na ${releaseVersion} pomocí F-Droidu";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "an_update_for_fritter_is_available": MessageLookupByLibrary.simpleMessage("Je dostupná aktualizace Squawkeru! 🚀"),
    ...
    "confirm_close_fritter": MessageLookupByLibrary.simpleMessage("Opravdu chcete zavřít Squawker?"),
    ...
    "could_not_contact_twitter": MessageLookupByLibrary.simpleMessage("Nepodařilo se kontaktovat Twitter/X"),
    ...
    "enter_your_twitter_username": MessageLookupByLibrary.simpleMessage("Zadejte vaše uživatelské jméno na Twitter/Xu"),
    ...
    "forbidden": MessageLookupByLibrary.simpleMessage("Twitter/X říká, že přístup k tomuto je zamítnut"),
    "fritter": MessageLookupByLibrary.simpleMessage("Squawker"),
    "fritter_blue": MessageLookupByLibrary.simpleMessage("Squawkerová modrá"),
    "functionality_unsupported": MessageLookupByLibrary.simpleMessage("Tato funkce již není podporována Twitter/Xem!"),
    "general": MessageLookupByLibrary.simpleMessage("Obecné"),
    "group_name": m6,
    "groups": MessageLookupByLibrary.simpleMessage("Skupiny"),
    "help_make_fritter_even_better": MessageLookupByLibrary.simpleMessage("Pomozte vylepšit Squawker"),
    "help_support_fritters_future": MessageLookupByLibrary.simpleMessage("Podpořte vývoj Squawkeru"),
    ...
    "import_from_twitter": MessageLookupByLibrary.simpleMessage("Importovat z Twitter/Xu"),
    ...
    "something_broke_in_fritter": MessageLookupByLibrary.simpleMessage("Něco se pokazilo ve Squawkeru."),
    ...
    "thanks_for_helping_fritter": MessageLookupByLibrary.simpleMessage("Děkujeme za pomoc Squawkeru! 💖"),
    "the_file_does_not_exist_please_ensure_it_is_located_at_file_path": m15,
    "the_github_issue": MessageLookupByLibrary.simpleMessage("problém na GitHubu (#143)"),
