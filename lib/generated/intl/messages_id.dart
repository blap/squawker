...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(snapshotData) => "${snapshotData} pengguna terimpor sejauh ini";
  ...
  static String m11(errorMessage) => "Mohon periksa koneksi Internet Anda.\n\n${errorMessage}";

  static String m13(releaseVersion) => "Ketuk untuk mengunduh ${releaseVersion}";

  static String m14(getMediaType) => "Ketuk untuk menampilkan ${getMediaType}";

  static String m15(filePath) => "Berkas tidak ada. Pastikan bahwa itu terletak di ${filePath}";

  static String m16(thisTweetUserName, timeAgo) => "${thisTweetUserName} mencuit ulang ${timeAgo}";
  ...
  static String m18(widgetPlaceName) => "Tidak bisa memuat tren untuk ${widgetPlaceName}";

  static String m19(responseStatusCode) =>
      "Tidak dapat menyimpan media. Twitter/X mengembalikan status ${responseStatusCode}";

  static String m20(releaseVersion) => "Perbarui ke ${releaseVersion} lewat klien F-Droid Anda";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "an_update_for_fritter_is_available": MessageLookupByLibrary.simpleMessage("Pembaruan untuk Squawker tersedia! 🚀"),
    ...
    "confirm_close_fritter": MessageLookupByLibrary.simpleMessage("Apakah Anda yakin ingin menutup Squawker?"),
    ...
    "could_not_contact_twitter": MessageLookupByLibrary.simpleMessage("Tidak bisa menghubungi Twitter/X"),
    ...
    "enter_your_twitter_username": MessageLookupByLibrary.simpleMessage("Masukkan nama pengguna Twitter/X Anda"),
    ...
    "forbidden": MessageLookupByLibrary.simpleMessage("Twitter/X mengatakan bahwa akses ke sini terlarang"),
    ...
    "help_make_fritter_even_better": MessageLookupByLibrary.simpleMessage("Bantu Squawker menjadi lebih baik"),
    "help_support_fritters_future": MessageLookupByLibrary.simpleMessage("Bantu dukung masa depan Squawker"),
    ...
    "import_from_twitter": MessageLookupByLibrary.simpleMessage("Impor dari Twitter/X"),
    ...
    "something_broke_in_fritter": MessageLookupByLibrary.simpleMessage("Sesuatu rusak di Squawker."),
    ...
    "thanks_for_helping_fritter": MessageLookupByLibrary.simpleMessage("Terima kasih telah membantu Squawker! 💖"),
    "the_file_does_not_exist_please_ensure_it_is_located_at_file_path": m15,
    "the_github_issue": MessageLookupByLibrary.simpleMessage("isu GitHub (#143)"),
    ...
    "whether_errors_should_be_reported_to_": MessageLookupByLibrary.simpleMessage("Apakah galat harus dilaporkan ke "),
