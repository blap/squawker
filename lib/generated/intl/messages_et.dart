...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(name) => "Kas sa oled kindel, et soovid kustutada tellimuste grupi ${name}?";
  ...
  static String m5(snapshotData) => "${snapshotData} kasutaja importimine on valmis";

  static String m6(name) => "Grupp: ${name}";

  static String m7(snapshotData) => "Seni on imporditud ${snapshotData} kasutajat";

  static String m8(date) => "Liitunud ${date}";

  static String m9(nbrGuestAccounts) => "Kasutusel on ${nbrGuestAccounts} külaliskonto(t)";
  ...
  static String m11(errorMessage) => "Palun kontrolli oma võrguühendust.\n\n${errorMessage}";

  static String m12(nbrRegularAccounts) => "Tavakontod (${nbrRegularAccounts}):";

  static String m13(releaseVersion) => "Versiooni ${releaseVersion} allalaadimiseks klõpsi";

  static String m14(getMediaType) => "${getMediaType} kuvamiseks klõpsi";

  static String m15(filePath) => "Faili ei leidu. Palun kontrolli, et ta asuks siin ${filePath}";

  static String m16(thisTweetUserName, timeAgo) => "${thisTweetUserName} kirjutas ${timeAgo} eest kordussäutsu";
  ...
  static String m20(releaseVersion) => "Uuenduseks versioonini ${releaseVersion} kasuta oma F-Droidi klienti";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "add_account_title": MessageLookupByLibrary.simpleMessage("Lisa kasutajakonto"),
    ...
    "allow_background_play_description": MessageLookupByLibrary.simpleMessage("Luba meediat esitada taustal"),
    "allow_background_play_label": MessageLookupByLibrary.simpleMessage("Meedia esitamine taustal"),
    ...
    "allow_background_play_other_apps_label": MessageLookupByLibrary.simpleMessage("Muud rakendused taustal"),
    ...
    "app_info": MessageLookupByLibrary.simpleMessage("Rakenduse üksikasjalik teave"),
    ...
    "community_notes_title": MessageLookupByLibrary.simpleMessage("Järgneva sisu on lisanud lugejad"),
    ...
    "could_not_contact_twitter": MessageLookupByLibrary.simpleMessage("Puudub ühendus Twitter/X\'iga"),
    ...
    "default_subscription_tab": MessageLookupByLibrary.simpleMessage("Tellimuste vaikimisi kaart"),
    ...
    "download_video_best_quality_label": MessageLookupByLibrary.simpleMessage("Allalaaditavate videote kvaliteet"),
    "downloading_media": MessageLookupByLibrary.simpleMessage("Laadin alla meediat..."),
    "edit_account_title": MessageLookupByLibrary.simpleMessage("Muuda kasutajakontot"),
    ...
    "enhanced_feeds_label": MessageLookupByLibrary.simpleMessage("Tõhusamad säutsuvood"),
    ...
    "enhanced_profile_label": MessageLookupByLibrary.simpleMessage("Tõhusamad kasutajaprofiilid"),
    ...
    "enhanced_searches_label": MessageLookupByLibrary.simpleMessage("Tõhusamad otsingud"),
    ...
    "enter_your_twitter_username": MessageLookupByLibrary.simpleMessage("Sisesta oma Twitter/Xi kasutajanimi"),
    "error_from_twitter": MessageLookupByLibrary.simpleMessage("Twitter/X\'i viga"),
    "exclusions_feed_description": MessageLookupByLibrary.simpleMessage(
      "Kasutajanimede loend, mida soovid säutsuvoost välistada",
    ),
    "exclusions_feed_label": MessageLookupByLibrary.simpleMessage("Välistused säutsuvoost"),
    "export": MessageLookupByLibrary.simpleMessage("Eksport"),
    "export_guest_accounts": MessageLookupByLibrary.simpleMessage("Kas ekspordime külaliskontod?"),
    ...
    "export_twitter_tokens": MessageLookupByLibrary.simpleMessage("Kas ekspordime Twitter/X tunnusload?"),
    ...
    "forbidden": MessageLookupByLibrary.simpleMessage("Twitter/X ütleb, et juurdepääs sellele sisule on keelatud"),
    ...
    "help_make_fritter_even_better": MessageLookupByLibrary.simpleMessage("Aita muuta Squawker\'it veelgi paremaks"),
    "help_support_fritters_future": MessageLookupByLibrary.simpleMessage("Toeta Squawker\'i arendust rahaliselt"),
    ...
    "import_from_twitter": MessageLookupByLibrary.simpleMessage("Impordi Twitter/Xist"),
    ...
    "keep_feed_offset_label": MessageLookupByLibrary.simpleMessage("Jäta meelde asukoht säutsuvoos"),
    ...
    "leaner_feeds_description": MessageLookupByLibrary.simpleMessage("Säutsudes ei kuvata linkide eelvaateid"),
    "leaner_feeds_label": MessageLookupByLibrary.simpleMessage("Kompaktsed säutsuvood"),
    ...
    "libre_translate_host": MessageLookupByLibrary.simpleMessage("LibreTranslate\'i server"),
    ...
    "mandatory_label": MessageLookupByLibrary.simpleMessage("Kohustuslikud väljad:"),
    "material_3": MessageLookupByLibrary.simpleMessage("Kasuta Material 3 teemat?"),
    ...
    "no_data_was_returned_which_should_never_happen_please_report_a_bug_if_possible": MessageLookupByLibrary.simpleMessage(
    ...
    "open_in_browser": MessageLookupByLibrary.simpleMessage("Ava veebibrauseris"),
    "option_confirm_close_description": MessageLookupByLibrary.simpleMessage("Rakenduse sulgemisel küsi kinnitust"),
    "option_confirm_close_label": MessageLookupByLibrary.simpleMessage("Rakenduse sulgemise kinnitus"),
    "option_navigation_animations_description": MessageLookupByLibrary.simpleMessage(
    ...
    "option_show_navigation_labels_label": MessageLookupByLibrary.simpleMessage("Tegevuste riba sildid"),
    "optional_label": MessageLookupByLibrary.simpleMessage("Täiendavad väljad:"),
    ...
    "proxy_description": MessageLookupByLibrary.simpleMessage("Kasuta puhverserverit kõikide päringute jaoks"),
    ...
    "remove_from_feed": MessageLookupByLibrary.simpleMessage("Eemalda säutsuvoost"),
    ...
    "share_tweet_as_image": MessageLookupByLibrary.simpleMessage("Jaga säutsu pildina"),
    ...
    "something_broke_in_fritter": MessageLookupByLibrary.simpleMessage("Midagi läks nüüd Squawker\'is katki."),
    ...
    "thanks_for_helping_fritter": MessageLookupByLibrary.simpleMessage("Täname, et aitad Squawker\'it! 💖"),
    "the_file_does_not_exist_please_ensure_it_is_located_at_file_path": m15,
    "the_github_issue": MessageLookupByLibrary.simpleMessage("veakirjeldus GitHub\'is (#143)"),
    ...
    "thumbnail_not_available": MessageLookupByLibrary.simpleMessage("Pisipilt pole saadaval"),
    ...
    "translators_description": MessageLookupByLibrary.simpleMessage("Kasuta sinu valitud LibreTranslate\'i liideseid"),
    ...
    "tweet_font_size_description": MessageLookupByLibrary.simpleMessage("Säutsudes kasutatav fondisuurus"),
    "tweet_font_size_label": MessageLookupByLibrary.simpleMessage("Kirjasuurus"),
    ...
    "tweets_number": m17,
    "twitter_account_types_both": MessageLookupByLibrary.simpleMessage("Külalis- ja tavakonto"),
    "twitter_account_types_description": MessageLookupByLibrary.simpleMessage("Kasutatav konto tüüp"),
    "twitter_account_types_label": MessageLookupByLibrary.simpleMessage("Konto tüüp"),
    "twitter_account_types_only_regular": MessageLookupByLibrary.simpleMessage("Ainult tavakonto"),
    "twitter_account_types_priority_to_regular": MessageLookupByLibrary.simpleMessage("Eelista tavakontot"),
    ...
    "username_exclude": MessageLookupByLibrary.simpleMessage("Välistatav kasutajanimi"),
    ...
    "whether_errors_should_be_reported_to_": MessageLookupByLibrary.simpleMessage("Teata vigadest veebirakenduses "),
